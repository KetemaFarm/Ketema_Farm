...
const LandListings = () => {
  ...
  const categories = ["All", "BALCONY", "ROOFTOP", "GARDEN", "UNUSED PLOT"];
        ...
        <div className="flex-1 mt-6 md:mt-0 mb-5">
          ...
          <div className="flex flex-row gap-6 items-center justify-center flex-wrap">
            {filteredLands.map((land) => (
              <div
                key={land.id}
                className="bg-white rounded-lg overflow-hidden  hover:border-gray-100 hover:shadow-md transition border-1 border-amber-900 w-[300px]"
              >
                <img
                  src={land.image}
                  alt={land.name}
